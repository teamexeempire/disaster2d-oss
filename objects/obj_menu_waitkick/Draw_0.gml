...
for(var k = ds_map_find_first(obj_menu_waiting.players); !is_undefined(k); k = ds_map_find_next(obj_menu_waiting.players, k))
{
	var player = obj_menu_waiting.players[? k];
